...
#     #         if p.grad is None:
#     #             print(f'{name} has no gradient. This is probably not what you want.')
#     #     print('on_after_backward exits.')
...
#         reset_peak_memory_stats(root_device)
#         synchronize(root_device)
#         self.start_time = time.time()

#     # def on_train_epoch_end(self, trainer, pl_module, outputs):
#     def on_train_epoch_end(self, trainer, pl_module):
#         synchronize(trainer.root_gpu)
#         max_memory = max_memory_allocated(trainer.strategy.root_device) / 2 ** 20
#         epoch_time = time.time() - self.start_time

#         try:
#             reduce_ = trainer.training_type_plugin.reduce
#             max_memory = reduce_(max_memory)
#             epoch_time = reduce_(epoch_time)
...
if __name__ == "__main__":
    ...
    # ignore_keys_callback = 'ignore_keys_callback' in callbacks_cfg
    # if ignore_keys_callback and hasattr(trainer_opt, 'resume_from_checkpoint'):
    #     callbacks_cfg.ignore_keys_callback.params['ckpt_path'] = trainer_opt.resume_from_checkpoint
    # elif ignore_keys_callback:
    #     del callbacks_cfg['ignore_keys_callback']

    # trainer_kwargs["callbacks"] = [instantiate_from_config(callbacks_cfg[k]) for k in callbacks_cfg]
    # from pprint import pprint
    # print('trainer_opt=')
    # pprint(trainer_opt, indent=4)
    # print('trainer_kwargs=')
    # pprint(trainer_kwargs, indent=4)
    # breakpoint()
    # trainer_opt
