...
class DDPM(LightningModule):
    ...
    def __init__(self,
        ...
        self.log_every_t_train = log_every_t
    ...
    def register_schedule(self, given_betas=None, beta_schedule="linear", timesteps=1000,
        ...
        assert len(alphas_cumprod) == self.num_timesteps, 'alphas have to be defined for each timestep'
    ...
    def p_sample_loop(self, shape, return_intermediates=False):
        ...
        for i in tqdm(reversed(range(0, num_timesteps)), desc='Sampling t', total=num_timesteps):
            ...
            if i % log_every_t == 0 or i == num_timesteps - 1:
    ...
    def forward(self, x, *args, **kwargs):
        ...
        t = torch.randint(0, self.num_timesteps, (len_x,), device=self.device, dtype=torch_int64)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log_images(batch, N=4, n_row=2, sample=True, split='val') #, return_keys=['inputs', 'samples', 'diffusion_row'],)
...
class LatentDiffusion(DDPM):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if batch_idx % self.log_every_t_train == 0:
            with torch_no_grad():
                self.log_images(batch, N=4, n_row=2, sample=True, split='train')
    ...
    def decode_first_stage(self, z, predict_cids=False, force_not_quantize=False):
        ...
        if hasattr(self, "split_input_params"):
            ...
            if split_input_params["patch_distributed_vq"]:
                ...
                output_list = [first_stage_model.decode(z[:, :, :, :, i]) for i in range(z.shape[-1])]
    ...
    def forward(self, x, c, *args, **kwargs):
        ...
        t = torch.randint(0, self.num_timesteps, (x.size(0),), device=self.device, dtype=torch_int64)
